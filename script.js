...
async function guardarCliente(event) {
  ...
  try {
    ...
    alert('Hubo un error al guardar el cliente. Por favor, inténtalo de nuevo.');
  }
}
...
async function cargarClientes() {
  ...
  try {
    ...
    listaClientes.innerHTML = '<p>Hubo un error al cargar los clientes.</p>';
  }
}
...
async function verDetalles(id) {
  try {
    ...
    alert(`
      ...
      Ubicación: ${clienteSeleccionado.ubicacion}
